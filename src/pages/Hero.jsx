      ...
      <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          <p className="text-lg lg:text-xl text-gray-700 mb-10 max-w-xl mx-auto lg:mx-0 font-medium leading-relaxed">
            A premier institution for advanced learning, paired with a top-class library. Discover courses, access thousands of resources, and shape your future.
          </p>
          ...
          <div className="grid grid-cols-3 gap-4 border-t border-[#0d98ba]/20 pt-8 max-w-lg mx-auto lg:mx-0">
            <div>
              <h3 className="text-3xl font-black text-[#0d98ba]">Top</h3>
              <p className="text-sm font-medium text-gray-600 mt-1">Faculty</p>
            </div>
            <div>
              <h3 className="text-3xl font-black text-[#0d98ba]">30+</h3>
              <p className="text-sm font-medium text-gray-600 mt-1">Library Seats</p>
            </div>
            <div>
              <h3 className="text-3xl font-black text-[#0d98ba]">100%</h3>
              <p className="text-sm font-medium text-gray-600 mt-1">Support</p>
            </div>
          </div>
        </div>
